...
function App() {
    return (
        <div style={{maxWidth:'800px', margin:'auto'}}>
            ...
            <div style={{marginBottom:'1.5rem', marginInlineEnd:'3rem', display:'flex', flexDirection:'row', justifyContent:'space-between'}}>
                <div>
                    {` < input />`}
                    <Input label="label" />
                </div>
                ...
                <div>
                    {` < input />`}
                    <Input default_focus="default_focus" label="label" />
                </div>
            </div>
            <div style={{marginBottom:'1.5rem', marginInlineEnd:'3rem'}}>
                {`<Input error />`}
